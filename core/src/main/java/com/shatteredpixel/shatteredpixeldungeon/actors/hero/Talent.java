...
//												(18, 0, 3),
	...
	DOUBLE_JUMP(24, 0, 4),
	//Shockwave T4
	EXPANDING_WAVE(25, 0, 4),
	STRIKING_WAVE(26, 0, 4),
	SHOCK_FORCE(27, 0, 4),
	//Endure T4
	SUSTAINED_RETRIBUTION(28, 0, 4),
	SHRUG_IT_OFF(29, 0, 4),
	EVEN_THE_ODDS(30, 0, 4),
	...
	ENERGIZING_MEAL(4, 1),
	INSCRIBED_POWER(5, 1),
	WAND_PRESERVATION(6, 1),
	ARCANE_VISION(7, 1),
	SHIELD_BATTERY(8, 1),
	//Mage T3
	DESPERATE_POWER(9, 1, 3),
	ALLY_WARP(10, 1, 3),
	//Battlemage T3
	EMPOWERED_STRIKE(11, 1, 3),
	MYSTICAL_CHARGE(12, 1, 3),
	EXCESS_CHARGE(13, 1, 3),
	//Warlock T3
	SOUL_EATER(14, 1, 3),
	SOUL_SIPHON(15, 1, 3),
	NECROMANCERS_MINIONS(16, 1, 3),
	//Elemental Blast T4
	BLAST_RADIUS(17, 1, 4),
	ELEMENTAL_POWER(18, 1, 4),
	REACTIVE_BARRIER(19, 1, 4),
	//Wild Magic T4
	WILD_POWER(20, 1, 4),
	FIRE_EVERYTHING(21, 1, 4),
	CONSERVED_MAGIC(23, 1, 4),
	//Warp Beacon T4
	TELEFRAG(24, 1, 4),
	REMOTE_BEACON(25, 1, 4),
	LONGRANGE_WARP(26, 1, 4),
	...
	//Rogue T2
	MYSTICAL_MEAL(4, 2),
	INSCRIBED_STEALTH(5, 2),
	WIDE_SEARCH(6, 2),
	SILENT_STEPS(7, 2),
	ROGUES_FORESIGHT(8, 2),
	//Rogue T3
	ENHANCED_RINGS(9, 2, 3),
	LIGHT_CLOAK(10, 2, 3),
	//Assassin T3
	ENHANCED_LETHALITY(11, 2, 3),
	ASSASSINS_REACH(12, 2, 3),
	BOUNTY_HUNTER(13, 2, 3),
	//Freerunner T3
	EVASIVE_ARMOR(14, 2, 3),
	PROJECTILE_MOMENTUM(15, 2, 3),
	SPEEDY_STEALTH(16, 2, 3),
	//Smoke Bomb T4
	HASTY_RETREAT(17, 2, 4),
	BODY_REPLACEMENT(18, 2, 4),
	SHADOW_STEP(19, 2, 4),
	//Death Mark T4
	FEAR_THE_REAPER(20, 2, 4),
	DEATHLY_DURABILITY(21, 2, 4),
	DOUBLE_MARK(22, 2, 4),
	//Shadow Clone T4
	SHADOW_BLADE(23, 2, 4),
	CLONED_ARMOR(24, 2, 4),
	...
	NATURES_AID(3, 3),
	//Huntress T2
	INVIGORATING_MEAL(4, 3),
	LIQUID_NATURE(5, 3),
	REJUVENATING_STEPS(6, 3),
	HEIGHTENED_SENSES(7, 3),
	DURABLE_PROJECTILES(8, 3),
	//Huntress T3
	POINT_BLANK(9, 3, 3),
	SEER_SHOT(10, 3, 3),
	//Sniper T3
	FARSIGHT(11, 3, 3),
	SHARED_ENCHANTMENT(12, 3, 3),
	SHARED_UPGRADES(13, 3, 3),
	//Warden T3
	DURABLE_TIPS(14, 3, 3),
	BARKSKIN(15, 3, 3),
	SHIELDING_DEW(16, 3, 3),
	//Spectral Blades T4
	FAN_OF_BLADES(17, 3, 4),
	PROJECTING_BLADES(18, 3, 4),
	SPIRIT_BLADES(19, 3, 4),
	//Natures Power T4
	GROWING_POWER(20, 3, 4),
	NATURES_WRATH(21, 3, 4),
	WILD_MOMENTUM(22, 3, 4),
	//Spirit Hawk T4
	EAGLE_EYE(23, 3, 4),
	GO_FOR_THE_EYES(24, 3, 4),
	SWIFT_SPIRIT(25, 3, 4),
	...
	FOCUSED_MEAL(4, 4),
	LIQUID_AGILITY(5, 4),
	WEAPON_RECHARGING(6, 4),
	LETHAL_HASTE(7, 4),
	SWIFT_EQUIP(8, 4),
	//Duelist T3
	PRECISE_ASSAULT(9, 4, 3),
	DEADLY_FOLLOWUP(10, 4, 3),
	//Champion T3
	VARIED_CHARGE(11, 4, 3),
	TWIN_UPGRADES(12, 4, 3),
	COMBINED_LETHALITY(13, 4, 3),
	//Monk T3
	UNENCUMBERED_SPIRIT(14, 4, 3),
	MONASTIC_VIGOR(15, 4, 3),
	COMBINED_ENERGY(16, 4, 3),
	//Challenge T4
	CLOSE_THE_GAP(17, 4, 4),
	INVIGORATING_VICTORY(18, 4, 4),
	ELIMINATION_MATCH(19, 4, 4),
	//Elemental Strike T4
	ELEMENTAL_REACH(20, 4, 4),
	STRIKING_FORCE(21, 4, 4),
	DIRECTED_POWER(22, 4, 4),
	//Feint T4
	FEIGNED_RETREAT(23, 4, 4),
	EXPOSE_WEAKNESS(24, 4, 4),
	COUNTER_ABILITY(25, 4, 4),
	...
	SHIELD_OF_LIGHT(3, 5),
	//Cleric T2
	ENLIGHTENING_MEAL(4, 5),
	RECALL_INSCRIPTION(5, 5),
	SUNRAY(6, 5),
	DIVINE_SENSE(7, 5),
	BLESS(8, 5),
	//Cleric T3
	CLEANSE(9, 5, 3),
	LIGHT_READING(10, 5, 3),
	//Priest T3
	HOLY_LANCE(11, 5, 3),
	HALLOWED_GROUND(12, 5, 3),
	MNEMONIC_PRAYER(13, 5, 3),
	//Paladin T3
	LAY_ON_HANDS(14, 5, 3),
	AURA_OF_PROTECTION(15, 5, 3),
	WALL_OF_LIGHT(16, 5, 3),
	//Ascended Form T4
	DIVINE_INTERVENTION(17, 5, 4),
	JUDGEMENT(18, 5, 4),
	FLASH(19, 5, 4),
	//Trinity T4
	BODY_FORM(20, 5, 4),
	...
	STASIS(25, 5, 4),
	//universal T4
	HEROIC_ENERGY(26, 5, 4), //See icon() and title() for special logic for this one
	//Ratmogrify T4
	RATSISTANCE(27, 5, 4),
	RATLOMACY(28, 5, 4),
	...
	//Aria T1
	QUICK_SWITCH		(0, 6, 4),
	CAREFUL_SCHOLAR		(1, 6, 4),
	CODEX_FUNDAMENTALS	(2, 6, 4),
	ELEMENTAL_GUARD_I	(3, 6, 4),
	PAGE_ECONOMY		(4, 6, 4),
	//Aria T2
	ELEMENTAL_RIDER		(5, 6, 4),
	SNAP_CONTROL		(6, 6, 4),
	INK_MARK			(7, 6, 4),
	SCRIPTORIUM			(8, 6, 4),
	ELEMENTAL_GUARD_II	(9, 6, 4),
	//Aria T3
	BALANCED_SCRIPT		(10, 6, 4),
	SCRIBES_STANCE		(11, 6, 4),
	//Aria_Harmony T3
	HARMONIC_CYCLE		(12, 6, 4),
	DUAL_ENGRAVING		(13, 6, 4),
	GENTLE_FLOW			(14, 6, 4),
	//Aria_Overheat T3
	REDLINE				(15, 6, 4),
	THERMAL_FEEDBACK	(16, 6, 4),
	SAFETY_VALVE		(17, 6, 4),
	//Aria_Grimoire&Ink T3
	DEEP_INK			(18, 6, 4),
	SIPHON_MARGIN		(19, 6, 4),
	EDITORS_CUT			(20, 6, 4),
	//Aria T4
	GRAND_THESIS		(21, 6, 4),
	IMMUTABLE_SCRIPT	(22, 6, 4),
	//Aria_Harmony T4
	ELEMENTAL_CHORD		(23, 6, 4),
	ROTATIONAL_MASTERY	(24, 6, 4),
	CONFLUENCE			(25, 6, 4),
	//Aria_Overheat T4
	INFERNAL_THESIS		(26, 6, 4),
	WHITE_HEAT			(27, 6, 4),
	HEAT_SINK_II		(28, 6, 4),
	//Aria_Grimoire&Ink T4
	BLACK_SUN_BRAND		(29, 6, 4),
	SCRIPTOR_KING		(30, 6, 4),
	SPREAD_THE_INK		(31, 6, 4);
