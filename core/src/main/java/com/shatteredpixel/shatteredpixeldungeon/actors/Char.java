...
public abstract class Char extends Actor {
	...
	protected static int hitMissIcon = -1;
	...
	public void damage( int dmg, Object src ) {
		...
		if (sprite != null) {
			...
			if (src == NewOverHeat.ElementType.WIND)					icon = FloatingText.PHYS_DMG_NO_BLOCK;
	...
	public boolean isImmune(Class effect ){
        ...
        immunes.addAll(NewOverHeat.elementImmunity(this));
	...
	public void heal(int amount) {
		...
		if (sprite != null) {
			sprite.showStatusWithIcon(CharSprite.POSITIVE, Integer.toString(amount), FloatingText.HEALING);
		}
	}
}
