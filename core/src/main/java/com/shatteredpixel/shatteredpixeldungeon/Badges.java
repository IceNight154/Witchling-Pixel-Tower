...
public class Badges {
	...
	static {
		...
		firstBossClassBadges.put(HeroClass.ARIA, Badge.BOSS_SLAIN_1_ARIA);
	...
	static {
		...
		victoryClassBadges.put(HeroClass.ARIA, Badge.VICTORY_ARIA);
	}
	...
	public static void validateAriaUnlock(){
		if (Statistics.ariaUnLocked  && !isUnlocked(Badge.UNLOCK_ARIA)){
			displayBadge( Badge.UNLOCK_ARIA );
		}
	}
